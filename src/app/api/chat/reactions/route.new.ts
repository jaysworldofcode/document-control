...
export async function POST(request: NextRequest) {
  try {
    ...
    const project = message.projects as any;
    const hasAccess = 
      project?.organization_id === payload.organizationId || // Organization owner
      project?.project_members?.some((member: any) => member.user_id === payload.userId); // Project member
