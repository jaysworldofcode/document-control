...
// Field Rules for auto-generation and concatenation
export interface FieldRule {
  type: 'concatenation';    // Future rule types can be added
  sourceFields: string[];   // Array of field IDs to use as sources
  separator?: string;       // Basic separator between concatenated fields (optional now)
  formula?: string;         // Custom formula for concatenation (e.g., "${field1}-${field2}-(${field3})")
}
...
export interface CustomField {
  ...
  isActive: boolean;
  rule?: FieldRule; // Optional rule for auto-generating field value
  readOnly?: boolean; // Whether field can be edited directly (false) or is generated by rule (true)
}
